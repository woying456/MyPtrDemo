...
//        mTitleBar.mRightTextView.setBackgroundResource(R.drawable.gmacs_blue_btn_stroke);
    ...
    protected void initData() {
        ...
        gridView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                startPhotoBrowserActivity(position, false);
            }
        });
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (resultCode == RESULT_OK) {
            ...
            } else if (requestCode == AlbumConstant.REQUEST_CODE_ALBUM_BROWSER) {
                if (data != null) {
...
//                ListView listView = (ListView) LayoutInflater.from(GmacsAlbumActivity.this).inflate(R.imageContainer.gmacs_activity_album_dir, null);
...
//                popupWindow.showAtLocation(gridView, Gravity.BOTTOM | Gravity.CENTER_HORIZONTAL, 0, 0);
        ...
        mPreviewBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (selectedDataList.size() > 0) {
                    startPhotoBrowserActivity(0, true);
                } else {
                    ToastUtil.showToast(R.string.select_picture_first);
                }
            }
    ...
    private void startPhotoBrowserActivity(int position, boolean isPreview) {
        Intent intent = new Intent(GmacsAlbumActivity.this, GmacsPhotoBrowserActivity.class);
        ...
        startActivityForResult(intent, AlbumConstant.REQUEST_CODE_ALBUM_BROWSER);
    }
    ...
    private void gotoGmacsImgDirsActivity() {
        ...
        startActivityForResult(intent, AlbumConstant.REQUEST_CODE_ALBUM);
