...
public class PublicAccountMenu extends LinearLayout implements View.OnClickListener {
    ...
    protected void onFinishInflate() {
        ...
        ImageView keyboard = (ImageView) findViewById(R.id.iv_public_account_keyboard_up);
    ...
    private void initMenu() {
        if (config != null) {
            ...
            for (int i = 0; i < primaryItemCount; i++) {
                ...
                SparseArray<ArrayList<Integer>> secondaryContentIndex = config.getSecondaryContentIndex();
...
//                synchronized (popupWindow) {
                ...
                int maxTextWidth = (int) Math.ceil(((TextView) layoutInflater.inflate(
                        ...
                        get((Integer) tag).get(maxIndex))) + GmacsUtils.dipToPixel(20));
                    ...
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                        try {
                            ...
                            intent.putExtra(GmacsWebViewActivity.EXTRA_TITLE, config.getSecondaryTitle().
                                    get(config.getSecondaryContentIndex().get((Integer) v.getTag()).get(position)));
