...
public class DiskBasedCache implements Cache {
     ...
     */
    private DiskBasedCache(File rootDirectory, int maxCacheSizeInBytes) {
     ...
     */
    @Override
    public synchronized void put(String key, File localFile) {
    ...
    static class CacheHeader {
        ...
        CacheHeader(String key, long length) {
            this.key = key;
            this.size = length;
